...
1) ```npm run-script launch:local``` - spins a local json-server at localhost:8080 and yeilds data from db.json

2) ```npm run-script launch:remote``` - replaces the base url from localhost:8080 to "some.url" specified in .env.remote
