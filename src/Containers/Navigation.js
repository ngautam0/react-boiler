...
const ErrorClassLink = props => <Link to='/errordemo' {...props} />
      ...
      <div>
        <MUIAppBar position='static' color='primary'>
          <Toolbar>
            ...
            <Button component={ErrorClassLink}>Error Boundary</Button>
            <Button component={HomeLink}>Home:Protected</Button>
